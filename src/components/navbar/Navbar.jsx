        ...
        <div className='container'>
            <div className="logo">
                <Link to="/" className='link'>
                    <span className='text'>Bank Ledger Pro</span>
                </Link>
            ...
            <div className="links">
                ...
                <span>Explore</span>
                <span>English</span> */}
                {currentUser && <Link to="/list" className='link'>Mutasi</Link>}
                {!currentUser && <Link to="/login" className='link'>Sign in</Link>}
                {!currentUser && <button><Link to="/register" className='link'>Register</Link></button>}
                {currentUser && (
